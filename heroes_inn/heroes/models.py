...
class Character(models.Model):
    ...
    weapons = models.ManyToManyField('Weapon', blank=True, null=True)
    attacks_and_spellcasting = models.ManyToManyField('Spell', blank=True, null=True)
    equipment = models.ManyToManyField('Item', blank=True, null=True)
    features_and_traits = models.ManyToManyField('Feature', blank=True, null=True)
